...
function FacultyDashboard() {
  ...
  return (
    <div style={{ backgroundColor: '#B4B4B3', minHeight: '100vh' }}>
      <Navbar expand="lg" className="mb-3" style={{ backgroundColor: '#61677A', height: '4rem', position: 'fixed', top: 0, width: '100%', zIndex: 1000 }}>
      ...
      <div className="d-flex justify-content-between mt-3">
        <h2 className="mx-3" style={{ fontSize: '3.5rem',  marginTop:'3.3rem'}}>Welcome {userName}</h2>
        <div className="d-flex align-items-center mt-3  ">
          <Button className="btn btn-primary align-items-center  me-5" style={{ height: '3.5rem', width: '14rem' }}onClick={handleRequest} >
            <p className="m-0 me-2" style={{ fontSize: '1.5rem', marginTop:'3.3rem'}}>Make a Request</p>
          </Button>
        </div>
      </div>
                      ...
                      {approvedRequests.length === 0 ? (
                        ...
                        approvedRequests.map((request, index) => (
                          ...
                          <td>{index + 1}</td>
                            ...
                            <td>{request.purpose}</td>
                            <td>
                              <FaEye onClick={() => handleViewRequestDetails(request.request_id)} style={{ cursor: 'pointer' }} />
                            </td>
                          </tr>
                        ))
                      )}
      ...
      <Modal show={selectedRequest !== null} onHide={handleCloseModal}>
        ...
        <Modal.Body>
          {selectedRequest && (
            ...
            <p><strong>Designation: </strong> {selectedRequest.designation}</p>
            <p><strong>Destination From:</strong>  {selectedRequest.destinationFrom}</p>
            <p><strong>Destination To: </strong> {selectedRequest.destinationTo}</p>
